...
<div class="hero-unit">
    <h1><?php echo $msg;?></h1>
    <form action="<?php echo HOME_URL.'/add.php';?>" method="post">
        <textarea id="data" name="data" style="margin-top:50px;width:100%" rows="10"></textarea>
        <input type="submit" value="Add this!" class="btn btn-primary btn-large">
    </form>
</div>
<?php showBottom(  );?>