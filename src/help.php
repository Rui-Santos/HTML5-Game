...
<div class="row">
    <div class="span8">
        ...
        <p>The last tab is the "Solution" tab. If you go to that tab, the game will ask you if you are 100% sure you want to cheat, and if you say yes, the game will tell you the data.</p>
    </div>
    <div class="span4">
